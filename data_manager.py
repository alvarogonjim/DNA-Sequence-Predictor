...
class DataHandler:
    def __init__(self, fname):
        ...
        self.kmer_set = {} # kmer feature
        self.neigborhoods = {} # neighborhoods feature

        self.alph = "GATC" # letter in the dictionary
        self.precomputed = {}
            ...
            for j in range(d - k + 1):
                ...
                if kmer not in self.precomputed:
                    ...
                    self.precomputed[kmer] = [
                        self.kmer_set[neighbor]
                        for neighbor in Mneighborhood
                        if neighbor in self.kmer_set
                    ]
